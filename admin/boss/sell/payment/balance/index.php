...
<?php echo $translations['sell-change'] ?? 'Vissza'; ?>
                        ...
                        <div class="pc-head-title">
                            ...
                            <h3><?php
<?php echo $translations['customaddmoneyheader'] ?? 'Egyenleg feltöltés'; ?></h3>
                        </div>
                    </div>
...
<?php echo $translations["ticketinfo"]; ?></h5>
                            ...
                            <div class="pc-line">
                                <span><?php
<?php echo $translations["price"]; ?></span>
                                <b>+<?php
<?php echo number_format((float) $balance, 0, ',', '.'); ?> <?php
<?php echo $currency; ?></b>
                            </div>
                            <div class="pc-line">
                                <span><?php
<?php echo $translations['profilebalancepay'] ?? 'Jelenlegi egyenleg'; ?></span>
                                <b><?php
<?php echo number_format((float) $current_balance, 0, ',', '.'); ?> <?php
<?php echo $currency; ?></b>
                            </div>
                            <div class="pc-total">
                                <span><?php
<?php echo $translations["newprofilebalance"]; ?></span>
                                <span class="pc-total-val"><?php
<?php echo number_format((float) $current_balance + (float) $balance, 0, ',', '.'); ?> <?php
